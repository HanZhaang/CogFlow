...
from data.dataloader_rat import seq_collate_rat, seq_collate_imle_train_rat
...
def parse_config():
    ...
    # Basic configuration
    parser.add_argument('--cfg', default='cfg/rat/imle.yml', type=str, help="Config file path")
...
def build_data_loader(cfg, args):
    ...
    train_loader = DataLoader(
        ...
        shuffle=True,
        num_workers=4,
        collate_fn=seq_collate_imle_train_rat,
        pin_memory=True)
